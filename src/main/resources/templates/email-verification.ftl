                                ...
                                <table dir="ltr" style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <span style="font-weight: 400;">Thank you for joining <strong>Shopping App</strong>!</span><br/><br/>
                                            <span style="font-weight: 400;">To complete the registration process, please confirm your email address to activate your account</span>
                                            ...
                                            <p class="tw-signoff"
                                               style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                Our best, <br/> Shopping App team</p>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
